...
% WRITE_LOG_MESSAGE Prints a structured log message.
%   level: 'INFO', 'DEBUG', 'WARN', 'ERROR'
%   message: The string message to log.
%   data_struct: (Optional) A struct with key-value pairs for context.

timestamp = string(datetime('now','Format', 'yyyy-MM-dd__HH:mm:SS'));
log_entry = sprintf('[%s] [%s] - %s', timestamp, upper(level), message);
