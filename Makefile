...
.PHONY: help install setup-conda install-python pipeline clean lint format test
...
install: setup-conda install-python ## Run the complete one-time project setup (Conda env + uv Python package install)
